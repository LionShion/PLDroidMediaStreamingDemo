...
public class MainActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mInputTextTV = findViewById(R.id.input_url);
        mStreamTypeSpinner = findViewById(R.id.stream_types);
        mDebugModeCheckBox = findViewById(R.id.debug_mode);
        mQuicPushButton = findViewById(R.id.transfer_quic);
